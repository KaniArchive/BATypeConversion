...
public class ExportTypeConversionGlobal extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        // Force Ghidra to analyze the program to resolve jump tables missing from -noanalysis
        tMonitor.setMessage("Running AutoAnalysis to resolve switches...");
        AutoAnalysisManager mgr = AutoAnalysisManager.getAnalysisManager(currentProgram);
        mgr.initializeOptions();
        mgr.reAnalyzeAll(null);
        mgr.startAnalysis(tMonitor);
